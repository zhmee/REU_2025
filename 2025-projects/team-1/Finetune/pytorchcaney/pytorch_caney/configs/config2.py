...
_C.MODEL.PREPROCESSOR = CN()
_C.MODEL.PREPROCESSOR.NAME = "mlp"       # default preprocessor type
_C.MODEL.PREPROCESSOR.HIDDEN_DIMS = [32] # default MLP hidden dims
_C.MODEL.PREPROCESSOR.KERNEL_SIZES = [3, 3]  # for conv only, default
_C.MODEL.PREPROCESSOR.OUT_CHANNELS = 14
# Encoder type for fine-tuning
_C.MODEL.ENCODER = CN()
_C.MODEL.ENCODER.NAME = 'SatVision'
_C.MODEL.ENCODER.IN_CHANNELS = 14
_C.MODEL.ENCODER.FREEZE_DEPTH = -1
...
_C.MODEL.SWINV2.DROP_RATE = 0.0
_C.MODEL.SWINV2.DROP_PATH_RATE = 0.0
# -----------------------------------------------------------------------------
# Training settings
# -----------------------------------------------------------------------------
_C.LOSS = CN()
