...
_C.MODEL.PREPROCESSOR.NAME = ''
_C.MODEL.PREPROCESSOR.HIDDEN_DIMS = []
_C.MODEL.PREPROCESSOR.CONV_KERNEL_SIZE = 1
# Freeze layer, LORA
_C.MODEL.FREEZE_LAYER = -1
_C.MODEL.FREEZE_ALL = False
_C.MODEL.LORA = False
_C.MODEL.LORA_RANK = 64
_C.MODEL.VPT = False
_C.MODEL.NUM_PROMPTS = 0
# Model type
